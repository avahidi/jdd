...
public class Configuration {
    ...
    // bdd
    public final static int DEFAULT_BDD_OPCACHE_DIV = 1;
    /**
     * see #bddOpcacheDiv
     */
    public final static int DEFAULT_BDD_NEGCACHE_DIV = 2;
    /**
     * see #bddNegcacheDiv
     */
    public final static int DEFAULT_BDD_ITECACHE_DIV = 4;
    /**
     * see #bddItecacheDiv
     */
    public final static int DEFAULT_BDD_QUANTCACHE_DIV = 3;
    /**
     * see #bddOpcacheDiv
     */
    public final static int DEFAULT_BDD_RELPRODCACHE_DIV = 2;
    /**
     * see #bddRelprodcacheDiv
     */
    public final static int DEFAULT_BDD_REPLACECACHE_DIV = 3;
    /**
     * see #bddReplacecheDiv
     */
    public final static int DEFAULT_BDD_SATCOUNT_DIV = 8;
    /**
     * see #bddSatcountDiv
     */


    public final static int DEFAULT_MAX_NODE_INCREASE = 100000;
    /**
     * see #maxNodeIncrease
     */
    public final static int DEFAULT_MIN_FREE_NODES_PROCENT = 20;
    /**
     * see #minFreeNodesProcent
     */
    public final static int DEFAULT_MAX_NODE_FREE = DEFAULT_MAX_NODE_INCREASE;
    /**
     * see #maxNodeFree
     */


    public final static int DEFAULT_MAX_SIMPLECACHE_GROWS = 5;
    /**
     * see #maxSimplecacheGrows
     */
    public final static int DEFAULT_MIN_SIMPLECACHE_HITRATE_TO_GROW = 40;
    /**
     * see #minSimplecacheHitrateToGrow
     */
    public final static int DEFAULT_MIN_SIMPLECACHE_ACCESS_TO_GROW = 15;
    /**
     * see #minSimplecacheAccessToGrow
     */


    public final static byte DEFAULT_CACHEENTRY_STICKY_HITS = 16;
    /**
     * see #cacheentryStickyHits
     */

    public final static int DEFAULT_MAX_CACHE_GROWS = 3;
    /**
     * see #maxCacheGrows
     */
    ...
    public final static int ZDD_UNARY_CACHE_DIV = 2;
    /**
     * see #zddUnaryCacheDiv
     */
    public final static int ZDD_BINARY_CACHE_DIV = 2;
    /**
     * see #zddBinaryCacheDiv
     */
    public final static int ZDD_UNATE_CACHE_DIV = 2;
    /**
     * see #zddUnateCacheDiv
     */
    public final static int ZDD_CSP_CACHE_DIV = 2;
    /**
     * see #zddCSPCacheDiv
     */
