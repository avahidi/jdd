...
public final class HashFunctions {
     ...
     */
    public static int mix_wang(int i) {
        i += ~(i << 15);
        i ^= (i >>> 10);
        i += ~(i << 3);
        i ^= (i >>> 6);
     ...
     */
    public static int mix_jenkins(int i) {
        i += (i << 12);
        i ^= (i >> 22);
        i += (i << 4);
        i ^= (i >> 9);
     ...
     */
    private static long pair(long i, long j) {
     ...
     */
    public static int hash_pair(int a, int b) {
        return (int) pair(a, b);
    }
     ...
     */
    public static int hash_pair(int a, int b, int c) {
     ...
     */
    public static int hash_prime(int a, int b) {
     ...
     */
    public static int hash_prime(int a, int b, int c) {
     ...
     */
    public static int hash_jenkins(int a, int b, int c) {
     ...
     * one round of FNV
     */
    private static int hash_FNV_round(int init, int word) {
     ...
     */
    public static int hash_FNV(int a, int b, int c) {
        int hash = FNV_OFFSET;
     ...
     */
    public static int hash_FNV(int[] data, int offset, int len) {
        int hash = FNV_OFFSET;
        for (int i = 0; i < len; i++)
