...
public class Allocator {
    ...
    private static final long[] stats_count = new long[TYPE_COUNT];
    private static final long[] stats_total = new long[TYPE_COUNT];
    private static final long[] stats_max = new long[TYPE_COUNT];
