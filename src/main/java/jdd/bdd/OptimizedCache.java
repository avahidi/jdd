...
public final class OptimizedCache extends SimpleCache {
     ...
     * more statistics...
     */
    private long partial_count, partial_kept, partial_given_up;
     ...
     * of a partial clean
     */
    private boolean shouldWipeUnusedCache() {
    ...
    private int partial_clean3(NodeTable nt) {
        int ok = 0;
    ...
    private int partial_clean2(NodeTable nt) {
        int ok = 0;
        for (int i = cache_size; i != 0; ) {
            i--;
    ...
    private int partial_clean1(NodeTable nt) {
        int ok = 0;
        for (int i = cache_size; i != 0; ) {
            i--;
