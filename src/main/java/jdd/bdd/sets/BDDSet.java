...
public class BDDSet implements Set {
    ...
    public Set copy() {
        return new BDDSet(universe, bdd);
    }
    ...
    public Set union(Set s) {
        return new BDDSet(universe, universe.or(bdd, ((BDDSet) s).bdd));
    }

    public Set intersection(Set s) {
        return new BDDSet(universe, universe.and(bdd, ((BDDSet) s).bdd));
    }
