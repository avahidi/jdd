...
public final class DoubleCache extends CacheBase {
    ...
    public long getMemoryUsage() {
        long ret = 0;
        if (in != null) ret += in.length * 4L;
        if (out != null) ret += out.length * 4L;
        return ret;
    }
    ...
    private boolean may_grow() {
        if (num_grows < Configuration.maxSimplecacheGrows) {
            ...
            if ((acs * 100) < (long) cache_size * Configuration.minSimplecacheAccessToGrow) return false;
